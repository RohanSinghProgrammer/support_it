  ...
  return (
    <aside className="fixed left-0 top-0 h-screen w-64 border-r border-border bg-card flex flex-col">
      ...
      <div className="border-t border-border p-4 space-y-4 flex gap-2">
        <LogoutConfirmButton
          variant="button"
          className="w-full flex items-center gap-3 px-4 py-1.5 rounded-lg hover:bg-secondary text-foreground transition-colors border border-red-200 dark:border-red-700"
